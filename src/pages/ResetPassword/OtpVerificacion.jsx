...
import OtpForm from '../../components/auth/resetPassword/OtpVerificacionForm';
import { Link } from 'react-router-dom';
import { useSelector } from 'react-redux';


const OtpVerificacion = () => {
        ...
        <div className="flex items-center justify-center h-screen bg-cover bg-center relative min-h-[680px]">
            ...
            <Container maxWidth="xs">
                <div className='w-full sm:shadow-lg sm:border bg-transparent sm:bg-white dark:sm:bg-neutral-900 dark:border-neutral-700 rounded-lg p-6 mb-16 z-10'>
                    ...
                    <div className="my-5 text-s flex justify-center font-semibold">
                        <p className="flex gap-1 text-gray-600 dark:text-gray-300">
                            ¿Escribiste mal el numero?
                            <Link to="/forgot-password" className="font-semibold hover:underline text-sky-600 dark:text-sky-400">
                                Regresar
                            </Link>
                        </p>
                    </div>
...
export default OtpVerificacion;
